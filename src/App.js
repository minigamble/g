...
function _login() { 
  setpce(50)
  if(phone.toString()==="123"){ if(password==="admin"){setpce(0);_admingrab();getusers();_admingrabibbi();setscreen("admin")}}else{
  axios.post("https://wind-east-albertonykus.glitch.me/user/find",{phone:phone})
...
<div id="intwos" >
  ...
  <div id="okuko" >
    ...
    <div id="btx" onClick= {e=> setscreen(15)} >View Project</div>
      ...
      <input id="allinput" style={{width:"85%"}} onChange={e=> setpassword(e.currentTarget.value)}  onKeyUp={e=>keypress(e)} />
...
<div id="dembabar2"> <span id='ok2'>{Data.map(i=> i.invite)}</span><div id='bt0111' onClick={e=> navigator.clipboard.writeText(Data.map(i=> i.invite).toString())}> Copy Invitation code</div></div>
<div id="dembabar3"> <span id='ok2'>https://valuebest.top/#/share</span><div id='bt0111' onClick={e=>  navigator.clipboard.writeText("https://valuebest.top/#/share")}> Copy link</div></div>
...
<div id='iti' style={_paga(2)} > Bank : Providus Bank <div> Account No : 9633568759 </div><span>Name: Dart(VPay Collections) </span></div>
